...
enum WORK_MODE { MODE_NONE = 0, MODE_INNER = 1, MODE_OUTER = 2, MODE_LASER = 3, MODE_ITS = 4 };
...
struct stLastJob
{
	...
	BOOL bContFixDef;
	CString sNumRangeFixDef, sNumContFixDef, sUltraSonicCleannerStTim, sEngItsUpCode, sEngItsDnCode;
	...
	stLastJob()
	{
		...
		sEngItsUpCode = _T(""); sEngItsDnCode = _T("");
