...
typedef enum _stSigInx {
	...
	// EngraveAutoSequence
	_EngAutoInit, _EngAutoInitCont, _EngAutoSeqMkSt, _EngAutoSeqOnMkIng, _EngAutoSeqMkDone, _EngAutoSeq2dReadSt, _EngAutoSeqOnReading2d, _EngAutoSeq2dReadDone, _EngAutoSeqFdDone,
	// Command
	_JobEnd,
	// DlgMyMsg
	_MyMsgYes, _MyMsgNo, _MyMsgCancel, _MyMsgOk, _MyMsg,
	// PLC
	_Buzzer, _TowerLamp, _ErrorRead2dCode,
	// GetCurrentInfoSignal
	_GetCurrentInfoSignal, _GetMonDispMainSignal,
	// Is Normal
	_IsIdle = RCV_OFFSET, _IsBusy, _IsConnect,
	// Is Display
	...
	_IsDoorRecoiler, _IsDoorAoiUp, _IsDoorAoiDn, _IsDoorMk, _IsDoorEngrave, _IsDoorUncoiler, _IsSaftyMk, _IsCleannerAoiUp, _IsCleannerAoiDn,
	_IsUltraSonicAoiDn, _IsUltraSonicEngrave, _IsFixDef, _IsUse380mm, _IsDispContRun, _IsDispLotEnd,
	// Is Menu01
	_IsTempStop, _IsTempPause, _IsLotCut, _IsMkPosMv, _IsMkVerify, _IsReelmapUp, _IsReelmapDn, _IsReelmapTot,
	_IsRemainMode, _IsEndWork, _IsReMk, _Is2Layer, _Is1LnMk, _Is2LnMk, _Is3LnMk, _Is4LnMk, _IsTotLnMk, _IsUpdateWork, _IsDispDefImg,
	// Is Menu02
	...
	_Is2DOffsetInitPos, _Is2DOffsetInitPosMove,
	// Is Menu03
	...
	// Is PLC
	_IsBuzzer, _IsTowerLamp, _IsErrorRead2dCode, 
	// Is GetCurrentInfoSignal
...
typedef enum _stItemInx {
	...
	// Dlg Info	
	_TestMode, _SampleShotNum, _LmtTotYld, _LmtPatlYld, _StripOutRatio, _CustomNeedRatio, _NumRangeFixDef, _NumContFixDef, _UltraSonicStTim,
	// Menu01
	...
	_EngFdDiffMax, _EngFdDiffRng, _EngFdDiffNum, _EngBuffInitPos, _EngBuffCurrPos, _EngItsUpCode, _EngItsDnCode,
	// Menu04
