...
BOOL CDlgMenu02::OnInitDialog() 
{
	...
	m_bTIM_BUF_ENC = TRUE;
	SetTimer(TIM_BUF_ENC, 100, NULL); // DispAxisPos()
...
void CDlgMenu02::Disp()
{
	...
	myStcData[17].SetText(pDoc->WorkingInfo.LastJob.sEngItsUpCode);	// IDC_STC_32	리더기 ITS Code pDoc->m_sItsCode
	...
	myStcData[15].SetText(pDoc->WorkingInfo.LastJob.sEngItsUpCode);	// IDC_STC_17	각인기 ITS Code pDoc->m_sItsCode
