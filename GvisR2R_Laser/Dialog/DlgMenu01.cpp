...
void CDlgMenu01::InitStcData()
{
	...
	myStcData[84].SubclassDlgItem(IDC_STC_ITS_CODE, this);
	myStcData[85].SubclassDlgItem(IDC_STC_ITS_CODE2, this);
	myStcData[86].SubclassDlgItem(IDC_STC_LOT2, this);
...
void CDlgMenu01::InitStcTitle()
{
	...
	myStcTitle[67].SubclassDlgItem(IDC_STC_ITS_, this);
	myStcTitle[67].SetFontName(_T("Arial"));
	myStcTitle[67].SetFontSize(14);
	myStcTitle[67].SetFontBold(TRUE);
	myStcTitle[67].SetTextColor(RGB_WHITE);
	myStcTitle[67].SetBkColor(RGB_DARKBLUE);

	myStcTitle[68].SubclassDlgItem(IDC_STC_ITS_2, this);
	myStcTitle[68].SetFontName(_T("Arial"));
	myStcTitle[68].SetFontSize(14);
	myStcTitle[68].SetFontBold(TRUE);
	myStcTitle[68].SetTextColor(RGB_WHITE);
	myStcTitle[68].SetBkColor(RGB_DARKBLUE);

	myStcTitle[69].SubclassDlgItem(IDC_STC_LT2, this);
	myStcTitle[69].SetFontName(_T("Arial"));
	myStcTitle[69].SetFontSize(12);
	myStcTitle[69].SetFontBold(TRUE);
	myStcTitle[69].SetTextColor(RGB_WHITE);
	myStcTitle[69].SetBkColor(RGB_DARKBLUE);
...
void CDlgMenu01::DispStripRatioIts()
{
	...
	if (pDoc->m_pReelMapIts)
	{
		...
		nMer[1] = pDoc->m_pReelMapIts->GetDefStrip(1);
		nMer[2] = pDoc->m_pReelMapIts->GetDefStrip(2);
		nMer[3] = pDoc->m_pReelMapIts->GetDefStrip(3);
	}
